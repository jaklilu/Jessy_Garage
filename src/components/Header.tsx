    ...
    <>
      ...
      <header ref={headerRef} className={`site-header ${open ? "is-menu-open" : ""}`}>
        <div className="site-header__bar container">
          ...
          <nav className="site-header__nav" aria-label="Primary">
            {navKeys.map((key) => {
              ...
              const active =
                key === "home" ? location.pathname === to : location.pathname.startsWith(to);
              return (
                <ScrollLink
                  key={key}
                  to={to}
          ...
          <div className="site-header__actions">
            ...
            <a className="site-header__call" href={`tel:${PHONE_TEL}`} aria-label={t.nav.call}>
        ...
        >
          ...
          <ScrollLink
            to={switchTo}
            className="site-header__drawer-lang"
            onClick={() => setOpen(false)}
            style={{ ["--i" as string]: navKeys.length }}
          >
          ...
          <a
            ...
            style={{ ["--i" as string]: navKeys.length + 1 }}
          >
